...
import time
import redis
from config import REDIS_HOST, REDIS_PORT, REDIS_USERNAME, REDIS_PASSWORD, TASK_QUEUE_KEY, RAG_TASK_QUEUE_KEY
...
def main():
    ...
    """
    r = redis.Redis(host=REDIS_HOST, port=REDIS_PORT, db=0, decode_responses=True, username=REDIS_USERNAME or None, password=REDIS_PASSWORD or None)
